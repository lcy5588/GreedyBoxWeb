...
function(a, b) {
    ...
    function e(a, b, c, d) {
        ...
        ("image" == a || "fluid" == a) && m(b, {
            alt: g.text ? (g.text.length > 16 ? g.text.substring(0, 16) + "â€¦": g.text) + " [" + h + "]": h
        }),
    ...
    z = {
        ...
        run: function(a) {
            ...
            for (m = 0; m < h.length; m++) {
                ...
                K ? 0 === J.src.indexOf(g.domain) ? c(g, f, J.src, I) : L && (M ? c(g, f, J.dataSrc, I) : !
                function(a, b, d, e, f) {
                    u(a,
                    function(a) {
                        a || c(b, d, e, f)
...
function(a) {
    ...
    a(function() {
        ...
        a(".highlight").each(function() {
            var b = '<div class="zero-clipboard"><span class="btn-clipboard">å¤åˆ¶</span></div>';
            a(this).before(b)
        });
        ...
        d.on("load",
        function() {
            e.data("placement", "top").attr("title", "å¤åˆ¶åˆ°å‰ªè´´æ¿").tooltip()
        }),
        d.on("dataRequested",
        function(b) {
        ...
        d.on("complete",
        function() {
            e.attr("title", "å¤åˆ¶å®Œæˆï¼").tooltip("fixTitle").tooltip("show").attr("title", "å¤åˆ¶åˆ°å‰ªè´´æ¿").tooltip("fixTitle")
        }),
        d.on("noflash wrongflash",
        function() {
            e.attr("title", "æ‚¨çš„æµè§ˆå™¨éœ€è¦å®‰è£… Flash æ’ä»¶").tooltip("fixTitle").tooltip("show")
        })
    })
} (jQuery);
