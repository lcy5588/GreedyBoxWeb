...
(function(a){a.validity.outputs.boostrap = {start:function(){$(".form-group").removeClass('has-error');},end:function(results){if (!results.valid && $.validity.settings.scrollTo) {location.hash = $(".fail:eq(0)").attr('id');}},raise:function($obj, msg){$obj.parent().addClass('has-error');},raiseAggregate:function($obj, msg){this.raise($obj, msg);}}})(jQuery);
