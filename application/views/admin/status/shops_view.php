<div id="page-items">
	...
	<ul class="nav nav-pills">
      ...
      <li class="active"><a href="<?php echo site_url('admin/status/shops')?>">按店铺</a></li>
	...
	<?php
	 foreach ($query->result() as $array):
        //条目开始
            ?>
        <tr>
            <th><?php echo $array->sellernick ?></th>
            <th><?php echo $array->count ?></th>
            <th><?php echo $array->sum ?></th>
            <th><?php echo $array->sum/$array->count ?></th>
          </tr>
        <?php
        //条目结束
        endforeach;?>
