	...
	<?php if($accountbooks->num_rows()>0){ ?>
  <div class="row" style="margin-top:10px;">
    ...
    <tbody>
	<?php
	 foreach ($accountbooks->result() as $accountbook):
	//条目开始
		?>
	<tr>
    	<td><?php echo $accountbook->bookid ?></td>
        <td><?php echo $accountbook->name ?></td>
        <td>
        	<a href="#" title="修改此条" class="btn_update" data-bookid="<?php echo $accountbook->bookid; ?>">修改</a>&nbsp;&nbsp;
        	<a href="#" title="删除此条" class="btn_delete"  data-bookid="<?php echo $accountbook->bookid; ?>">删除</a>
        </td>
      </tr>
	<?php
    //条目结束
